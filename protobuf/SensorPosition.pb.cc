...
static ::_pb::Metadata file_level_metadata_SensorPosition_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_SensorPosition_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_SensorPosition_2eproto = nullptr;

const uint32_t TableStruct_SensorPosition_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::Data3d, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::Data3d, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::Data3d, _impl_.x_),
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::Data3d, _impl_.y_),
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::Data3d, _impl_.z_),
  0,
  1,
  2,
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::GeneratedPosition, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::GeneratedPosition, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::GeneratedPosition, _impl_.sensorid_),
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::GeneratedPosition, _impl_.timestamp_usec_),
  PROTOBUF_FIELD_OFFSET(::PositionGenerator::GeneratedPosition, _impl_.position_),
  1,
  2,
  0,
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 9, -1, sizeof(::PositionGenerator::Data3d)},
  { 12, 21, -1, sizeof(::PositionGenerator::GeneratedPosition)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::PositionGenerator::_Data3d_default_instance_._instance,
  &::PositionGenerator::_GeneratedPosition_default_instance_._instance,
};

const char descriptor_table_protodef_SensorPosition_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\024SensorPosition.proto\022\021PositionGenerato"
  "r\")\n\006Data3d\022\t\n\001x\030\001 \002(\002\022\t\n\001y\030\002 \002(\002\022\t\n\001z\030\003"
  " \002(\002\"j\n\021GeneratedPosition\022\020\n\010sensorId\030\001 "
  "\002(\004\022\026\n\016timestamp_usec\030\002 \002(\004\022+\n\010position\030"
  "\003 \002(\0132\031.PositionGenerator.Data3d"
  ;
static ::_pbi::once_flag descriptor_table_SensorPosition_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_SensorPosition_2eproto = {
    false, false, 192, descriptor_table_protodef_SensorPosition_2eproto,
    "SensorPosition.proto",
    &descriptor_table_SensorPosition_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_SensorPosition_2eproto::offsets,
    file_level_metadata_SensorPosition_2eproto, file_level_enum_descriptors_SensorPosition_2eproto,
    file_level_service_descriptors_SensorPosition_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_SensorPosition_2eproto_getter() {
  return &descriptor_table_SensorPosition_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_SensorPosition_2eproto(&descriptor_table_SensorPosition_2eproto);
namespace PositionGenerator {
...
Data3d::Data3d(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:PositionGenerator.Data3d)
}
Data3d::Data3d(const Data3d& from)
  ...
  // @@protoc_insertion_point(copy_constructor:PositionGenerator.Data3d)
}
...
Data3d::~Data3d() {
  // @@protoc_insertion_point(destructor:PositionGenerator.Data3d)
...
void Data3d::Clear() {
// @@protoc_insertion_point(message_clear_start:PositionGenerator.Data3d)
...
uint8_t* Data3d::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:PositionGenerator.Data3d)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PositionGenerator.Data3d)
  return target;
}

size_t Data3d::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:PositionGenerator.Data3d)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:PositionGenerator.Data3d)
  size_t total_size = 0;
...
void Data3d::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:PositionGenerator.Data3d)
...
// @@protoc_insertion_point(class_specific_copy_from_start:PositionGenerator.Data3d)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Data3d::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_SensorPosition_2eproto_getter, &descriptor_table_SensorPosition_2eproto_once,
      file_level_metadata_SensorPosition_2eproto[0]);
}
...
class GeneratedPosition::_Internal {
 public:
  ...
  static const ::PositionGenerator::Data3d& position(const GeneratedPosition* msg);
...
const ::PositionGenerator::Data3d&
...
GeneratedPosition::GeneratedPosition(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:PositionGenerator.GeneratedPosition)
}
GeneratedPosition::GeneratedPosition(const GeneratedPosition& from)
  ...
  if (from._internal_has_position()) {
    _this->_impl_.position_ = new ::PositionGenerator::Data3d(*from._impl_.position_);
  }
  ...
  // @@protoc_insertion_point(copy_constructor:PositionGenerator.GeneratedPosition)
}
...
GeneratedPosition::~GeneratedPosition() {
  // @@protoc_insertion_point(destructor:PositionGenerator.GeneratedPosition)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:PositionGenerator.GeneratedPosition)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 16)) {
          ...
          goto handle_unusual;
        continue;
      // required .PositionGenerator.Data3d position = 3;
      case 3:
...
uint8_t* GeneratedPosition::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:PositionGenerator.GeneratedPosition)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PositionGenerator.GeneratedPosition)
  return target;
}

size_t GeneratedPosition::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:PositionGenerator.GeneratedPosition)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:PositionGenerator.GeneratedPosition)
  size_t total_size = 0;
...
void GeneratedPosition::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:PositionGenerator.GeneratedPosition)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000007u) {
    if (cached_has_bits & 0x00000001u) {
      _this->_internal_mutable_position()->::PositionGenerator::Data3d::MergeFrom(
...
// @@protoc_insertion_point(class_specific_copy_from_start:PositionGenerator.GeneratedPosition)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata GeneratedPosition::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_SensorPosition_2eproto_getter, &descriptor_table_SensorPosition_2eproto_once,
      file_level_metadata_SensorPosition_2eproto[1]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace PositionGenerator
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::PositionGenerator::Data3d*
Arena::CreateMaybeMessage< ::PositionGenerator::Data3d >(Arena* arena) {
  return Arena::CreateMessageInternal< ::PositionGenerator::Data3d >(arena);
}
template<> PROTOBUF_NOINLINE ::PositionGenerator::GeneratedPosition*
Arena::CreateMaybeMessage< ::PositionGenerator::GeneratedPosition >(Arena* arena) {
  return Arena::CreateMessageInternal< ::PositionGenerator::GeneratedPosition >(arena);
}
